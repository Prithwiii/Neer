...
function ComplaintSubmit({ token }) {
  ...
  return (
    <div className="dashboard-page nx complaints-page">
      <div className="dashboard-header"><div><h1>Submit Complaint</h1><p>Your complaint will be reviewed before publication.</p></div></div>
      <nav className="top-nav"><Link to="/complaints">All Complaints</Link><Link to="/complaints/submit">Submit Complaint</Link></nav>
